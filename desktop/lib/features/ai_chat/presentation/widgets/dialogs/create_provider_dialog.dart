              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    ...
                    final sourceType = (_selectedFormat != null) ? _selectedFormat!.name : _idController.text.trim().toLowerCase();
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: UIKit.inputDecoration(context).copyWith(hintText: hint),
            validator: (value) {
          ...
          DropdownButtonFormField<RequestFormatType>(
            ...
            items: formats.map((format) {
              return DropdownMenuItem(
                value: format.type,
                child: Row(children: [format.icon, const SizedBox(width: 8), Text(format.name, style: TextStyle(color: tokens.textPrimary))]),
              );
            }).toList(),
            onChanged: (value) {
              setState(() {
