...
import 'package:peers_touch_desktop/controller/ai_provider_controller.dart';
import 'package:peers_touch_desktop/widget/error_message_bar.dart';
...
class _AiServiceProviderPageState extends State<AiServiceProviderPage> {
  ...
  Widget _buildRightPanel(BuildContext context, AIProviderController controller) {
    ...
    if (selectedProvider == null) {
      return Expanded(child: Center(child: Text('请选择一个提供商')));
    }
