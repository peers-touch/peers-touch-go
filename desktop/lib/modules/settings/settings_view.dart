import 'package:peers_touch_desktop/controller/general_settings_controller.dart';
import 'package:peers_touch_desktop/controller/locale_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Obx(() => Text(
            localeController.translate('general') ?? 'General',
                    ...
                    _buildSettingsSection(
                      ...
                      [
                        _buildDropdownSetting(
                          context,
                          icon: Icons.language,
                          title: localeController.translate('language') ?? 'Language',
